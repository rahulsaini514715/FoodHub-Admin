import { StyleSheet, Text, View, TouchableOpacity, Alert, ActivityIndicator, FlatList, Image } from "react-native";
...
const CategoriesScreen = () => {
  ...
  const handleDelete = (id: string, name: string, productCount: number) => {
    const message = productCount > 0 ? `Are  you sure you want to delete ${name}? This will also delete it is ${productCount} product${productCount > 1 ? 's' : ''}` : `Are you sure you want to delete ${name} category`;
    Alert.alert(
      "Delete Category",
      message,
      [
